...
- **Posizioni** nello spazio (il centro di una <a href="obsidian://open?vault=Bobobob&file=Ray%20Tracing%2FL'equazione%20della%20sfera">Sfera</a>, l'origine della camera)
...
Normalizzare un vettore significa renderlo di lunghezza 1, mantenendo la stessa direzione.
Un vettore normalizzato (detto "vettore unitario") rappresenta una direzione pura, senza informazione sulla distanza. Nel ray tracing si usano continuamente: la direzione di un [[Raggio (Ray)]], la normale di una superficie, ecc. Se non normalizzi, i calcoli successivi danno risultati sballati perché la lunghezza "inquina" la direzione.
...
dove 0 è l'angolo tra i due vettori. Questo da come risultato 3 casi:
...
- Trovare le intersezioni [[Raggio (Ray)]]-<a href="obsidian://open?vault=Bobobob&file=Ray%20Tracing%2FL'equazione%20della%20sfera">Sfera</a> (risolve l'equazione di secondo grado)
