...
Esempio: un [[Raggio (Ray)|raggio]] rimbalza su rosso (0.8, 0, 0), poi su bianco (0.9, 0.9, 0.9), poi colpisce il cielo azzurro (0.5, 0.7, 1.0):
...
Senza un limite, un [[Raggio (Ray)|raggio]] potrebbe rimbalzare all'infinito (immagina due specchi paralleli). Questo significherebbe:
